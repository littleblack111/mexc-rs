use crate::spot::ws::message::{RawChannelMessage, RawChannelMessageData, RawEventChannelMessageData};
...
pub(crate) fn channel_message_to_spot_deals_message(channel_message: &RawChannelMessage) -> Result<SpotDealsMessage, ChannelMessageToSpotDealsMessageError> {
    ...
    let RawEventChannelMessageData::Deals {
        deals,
        ..
    } = &event
    else {
